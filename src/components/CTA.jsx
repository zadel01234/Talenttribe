const CTA = () => (
  <section
    className="relative overflow-hidden py-28 tribal-pattern-orange"
    style={{ background: '#f5a000' }}
  >
    <div
      className="absolute inset-0 opacity-30"
      style={{ background: 'linear-gradient(135deg, #ffd700 0%, #f5a000 100%)' }}
    />
    ...
    <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
      ...
      <p
        ...
        style={{ fontFamily: 'Montserrat', fontSize: '18px', color: 'rgba(61,0,0,0.7)', lineHeight: '1.7' }}
      >
      ...
      <div
        className="mt-10"
        style={{ fontFamily: 'Space Grotesk', fontWeight: 600, fontSize: '18px', color: '#3d0000', letterSpacing: '0.15em' }}
      >
        LEARN · GROW · CONNECT
      </div>
    </div>
